        ...
        <div className="w-full max-w-[480px]">
          ...
          <div className="mt-8 grid grid-cols-1 gap-4">
            <button
              ...
              className="flex items-center justify-center gap-3 w-full h-14 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 transition-all text-slate-700 dark:text-slate-200 font-semibold shadow-sm"
              type="button"
            >
